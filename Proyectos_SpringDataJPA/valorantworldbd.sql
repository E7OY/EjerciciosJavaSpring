...
CREATE TABLE IF NOT EXISTS `agentes` (
  ...
  `rol` enum('CENTINELA','INICIADOR','DUELISTA','CONTROLADOR') COLLATE utf8mb4_general_ci NOT NULL,
  `ultimate` varchar(55) COLLATE utf8mb4_general_ci NOT NULL,
  `pais` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `habilidades` (
  ...
  `poseedor` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `HabilidadesPoseedorTOAgentesFK` (`poseedor`)
...
CREATE TABLE IF NOT EXISTS `jugadores` (
  ...
  `nacionalidad` varchar(55) COLLATE utf8mb4_general_ci NOT NULL,
  `apodo` varchar(55) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Estructura de tabla para la tabla `jugadores_agentes`
--

DROP TABLE IF EXISTS `jugadores_agentes`;
CREATE TABLE IF NOT EXISTS `jugadores_agentes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `jugador_id` int NOT NULL,
  `agente_id` int NOT NULL,
  `fecha` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `jugadores_agentesToJugadoresFK` (`jugador_id`),
  KEY `jugadores_agentesToAgentesFK` (`agente_id`)
...
ALTER TABLE `habilidades`
  ADD CONSTRAINT `HabilidadesPoseedorTOAgentesFK` FOREIGN KEY (`poseedor`) REFERENCES `agentes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `jugadores_agentes`
--
ALTER TABLE `jugadores_agentes`
  ADD CONSTRAINT `jugadores_agentesToAgentesFK` FOREIGN KEY (`agente_id`) REFERENCES `agentes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `jugadores_agentesToJugadoresFK` FOREIGN KEY (`jugador_id`) REFERENCES `jugadores` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
